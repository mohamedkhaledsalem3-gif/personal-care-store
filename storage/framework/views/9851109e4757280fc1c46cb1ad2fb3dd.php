    ...
    <div class="mx-auto max-w-7xl">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homeCategories->isNotEmpty()): ?>
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $homeCategories->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a
                        href="<?php echo e(route('storefront.products.index', ['category' => $categorySlug])); ?>"
                    ...
                    >
                        ...
                        <div class="mx-auto flex aspect-square max-w-32 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-[#eee6df] to-[#dfe6da] text-3xl text-[#66755b] transition group-hover:scale-105">
                            <span>
                                <?php echo e(mb_substr($categoryName, 0, 1)); ?>
...
<section class="bg-[#f8f6f1] px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
    ...
    <div class="mx-auto max-w-7xl">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($productsForHome->isNotEmpty()): ?>

            <div class="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-4">

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $productsForHome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <article class="group overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <div class="relative">
                            ...
                            <a
                                href="<?php echo e(route('storefront.products.show', $product)); ?>"
                                class="block"
                            >
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#eee7e0] to-[#dfe5da]">
                                            <span class="text-5xl font-light text-[#718069]">
                                                <?php echo e(mb_substr($product->name ?? 'P', 0, 1)); ?>
                            ...
                            <button
                                ...
                                aria-label="إضافة <?php echo e($product->name); ?> إلى المفضلة"
                            >
                                ♡
                            </button>
                        ...
                        <div class="p-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($brandName): ?>
                            ...
                            <div class="mt-2 flex items-center gap-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rating !== null): ?>
                            ...
                            <div class="mt-3 flex items-end gap-2">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($oldPrice): ?>
                                    ...
                                    <span class="text-xs text-gray-400 line-through">
                                        <?php echo e(number_format((float) $oldPrice, 2)); ?>
...
<section class="bg-white px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    ...
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $needs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $need): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                <a
                    href="<?php echo e(route('storefront.products.index', ['q' => $need['query']])); ?>"
                ...
                >
                    ...
                    <div class="relative">
                        ...
                        <h3 class="mt-3 text-xl font-bold text-[#303930]">
                            <?php echo e($need['title']); ?>

                        </h3>

                        <p class="mt-2 text-sm leading-6 text-gray-500">
                            <?php echo e($need['description']); ?>
...
<section class="bg-[#f8f6f1] px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    ...
    <div class="mx-auto max-w-7xl">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homeBrands->isNotEmpty()): ?>

            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $homeBrands->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a
                        href="<?php echo e(route('storefront.products.index', ['brand' => $brandSlug])); ?>"
...
</section><?php /**PATH C:\laragon\www\personal-care-store\resources\views/storefront/home.blade.php ENDPATH**/ ?>