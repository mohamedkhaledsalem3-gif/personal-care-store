    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex min-h-16 items-center justify-between gap-4">
            ...
            <nav class="hidden items-center gap-6 lg:flex">
                ...
                <a
                    href="<?php echo e(route('storefront.home')); ?>#story"
                    class="text-sm font-medium text-gray-700 transition hover:text-[#66755b]"
                >
                    من نحن
                </a>
            ...
            <div class="flex items-center gap-1 sm:gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    ...
                    >
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($headerCartItemsCount > 0): ?>
                            <span
                            ...
                            >
                                <?php echo e($headerCartItemsCount); ?>
...
</header><?php /**PATH C:\laragon\www\personal-care-store\resources\views/storefront/partials/header.blade.php ENDPATH**/ ?>